...
public class FileUtil {
  ...
  //系统保存截图的路径
  public static final String SCREENCAPTURE_PATH = Environment.getExternalStoragePublicDirectory(
    Environment.DIRECTORY_PICTURES).getAbsolutePath()+File.separator+"Screenshots";
